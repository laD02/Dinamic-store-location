...

                        {
                            ...
                            <s-stack gap="small" paddingBlockStart="small">
                                <s-url-field 
                                    ...
                                    error={errorUrl ? 'Please enter the Shopify B2B store URL. It should be in the format: https://store.myshopify.com' : ''}
                                />
                                <s-password-field
                                    label="Shopify B2B API Key"
                                    placeholder="Enter Shopify B2B API Key"
                                    onInput={(e: any) => handleChangeB2B(e)}
                                    error={errorB2B ? 'Please enter the Shopify B2B API key.' : ''}
                                />
